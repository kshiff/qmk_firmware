 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Ctrl |  Alt |  GUI |Lower |    Space    |Raise | Left | Up   | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_ESC         , KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT}
},
 ...
 */
[_LOWER] = {
  {KC_TILD , KC_EXLM, KC_AT,   KC_HASH,       KC_DLR,        KC_PERC, KC_CIRC, KC_PLUS, KC_1,    KC_2,    KC_3,    KC_BSPC},
  {_______ , _______, _______, SGUI(KC_LBRC), SGUI(KC_RBRC), _______, _______, KC_UNDS, KC_4,    KC_5,    KC_6,    KC_MINS},
  {_______ , _______, _______, _______,       _______,       _______, _______, KC_PIPE, KC_7,    KC_8,    KC_9,    KC_SLSH},
  {MACSLEEP, _______, _______, _______,       _______,       _______, _______, _______, KC_DOT,  KC_0,    KC_ASTR, KC_EQL }
},
 ...
 */
[_RAISE] = {
  {KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_DEL },
  {_______, LGUI(LALT(KC_LEFT)), LGUI(LALT(KC_RGHT)), KC_AMPR, KC_ASTR, _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | Mute | Vol- | Vol+ |      |      | Home | Left | Down |Right | End  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 ...
 */
[_FUNCTION] = {
  {KC_ESC , KC_MRWD, KC_MPLY, KC_MFFD, _______, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, KC_PSCR, KC_DEL},
  {_______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END , _______},
